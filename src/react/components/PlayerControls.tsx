...
interface PlayerControlsProps {
  ...
  setActiveTool: React.Dispatch<React.SetStateAction<ControlViewOption>>;
    ...
    <div className="player-controls">
      ...
      <div className="dynamic-display">
        ...
        <div className={activeTool === 'default' ? '' : 'hidden'}>
          <PlayerHand
            items={gameManager.getPlayerHand()}
            selectedIndex={gameManager.getSelectedItemIndex()}
            deckCount={gameManager.getDeckItemCount()}
          />
        </div>
      </div>
      <div className="toolbar" id="toolbar">
        ...
        <div className="tools">
          ...
          <button className="button" onClick={handle3dClick}>
